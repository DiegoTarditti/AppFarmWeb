...
Generado: 2026-09-15 16:21 · rama `feat/ean-que-el-proveedor-entiende` · commit `0bd5f87`
...
| `analisis_ia_cache` | `AnalisisIaCache` | [2494](../database.py#L2494) |
| `analisis_sesiones` | `AnalisisSesion` | [2674](../database.py#L2674) |
| `anunciantes` | `Anunciante` | [2372](../database.py#L2372) |
| `api_keys` | `ApiKey` | [3333](../database.py#L3333) |
| `archivos_compartidos` | `ArchivoCompartido` | [1311](../database.py#L1311) |
| `backup_log` | `BackupLog` | [1192](../database.py#L1192) |
| `barcode_mappings` | `BarcodeMapping` | [2101](../database.py#L2101) |
| `bot_conversaciones` | `BotConversacion` | [3140](../database.py#L3140) |
| `bot_interacciones` | `BotInteraccion` | [3308](../database.py#L3308) |
| `bot_mensajes` | `BotMensaje` | [3202](../database.py#L3202) |
| `cadencia_lab_snapshot` | `CadenciaLabSnapshot` | [2450](../database.py#L2450) |
...
| `devolucion_receta` | `DevolucionReceta` | [2890](../database.py#L2890) |
| `documentos_pendientes` | `DocumentoPendiente` | [2414](../database.py#L2414) |
...
| `equivalencias_compra` | `EquivalenciaCompra` | [2596](../database.py#L2596) |
| `equivalencias_proveedor` | `EquivalenciaProveedor` | [2048](../database.py#L2048) |
| `erp_stock` | `ErpStock` | [1971](../database.py#L1971) |
| `estacionalidad_escenarios` | `EstacionalidadEscenario` | [2959](../database.py#L2959) |
| `estacionalidad_productos` | `EstacionalidadProducto` | [2991](../database.py#L2991) |
| `eventos_sla` | `EventoSLA` | [3265](../database.py#L3265) |
...
| `home_card_clicks` | `HomeCardClick` | [2544](../database.py#L2544) |
| `indice_inflacion` | `IndiceInflacion` | [2648](../database.py#L2648) |
| `informe_enviado` | `InformeEnviado` | [3251](../database.py#L3251) |
...
| `minimos_manuales` | `MinimoManual` | [3499](../database.py#L3499) |
| `modulo_packs` | `ModuloPack` | [2256](../database.py#L2256) |
| `modulos` | `Modulo` | [2243](../database.py#L2243) |
| `motivo_devolucion` | `MotivoDevolucion` | [2738](../database.py#L2738) |
...
| `obs_rowa_productos` | `ObsRowaProducto` | [3469](../database.py#L3469) |
...
| `ofertas_bot` | `OfertaBot` | [3215](../database.py#L3215) |
| `ofertas_minimo` | `OfertaMinimo` | [1239](../database.py#L1239) |
| `ofertas_registro` | `OfertaRegistro` | [3227](../database.py#L3227) |
| `pack_equivalencias` | `PackEquivalencia` | [2558](../database.py#L2558) |
| `pago_aplicaciones` | `PagoAplicacion` | [712](../database.py#L712) |
| `pagos` | `Pago` | [695](../database.py#L695) |
| `pagos_ajustes_cc` | `PagoAjusteCC` | [2389](../database.py#L2389) |
...
| `pedido_items` | `PedidoItem` | [2317](../database.py#L2317) |
| `pedido_obs_presets` | `PedidoObsPreset` | [804](../database.py#L804) |
| `pedidos` | `Pedido` | [2271](../database.py#L2271) |
| `pedidos_reparto` | `PedidoReparto` | [858](../database.py#L858) |
| `plantilla_campos` | `PlantillaCampo` | [2703](../database.py#L2703) |
| `plantillas` | `Plantilla` | [2718](../database.py#L2718) |
| `plantillas_exportacion` | `PlantillaExportacion` | [2689](../database.py#L2689) |
| `procesos_compra` | `ProcesoCompra` | [2340](../database.py#L2340) |
| `product_analytics` | `ProductAnalytics` | [2429](../database.py#L2429) |
| `producto_atributos` | `ProductoAtributo` | [2196](../database.py#L2196) |
| `producto_codigos_barra` | `ProductoCodigoBarra` | [2170](../database.py#L2170) |
| `producto_flags` | `ProductoFlag` | [1626](../database.py#L1626) |
| `producto_precios_hist` | `ProductoPrecioHist` | [2623](../database.py#L2623) |
| `productos` | `Producto` | [2112](../database.py#L2112) |
...
| `reclamo_items` | `ClaimItem` | [2028](../database.py#L2028) |
| `reclamos` | `Claim` | [2010](../database.py#L2010) |
| `rendicion_grupo` | `RendicionGrupo` | [2832](../database.py#L2832) |
| `rendicion_grupo_os` | `RendicionGrupoOS` | [2853](../database.py#L2853) |
| `rendicion_lote` | `RendicionLote` | [2756](../database.py#L2756) |
| `respuestas_rapidas` | `RespuestaRapida` | [3240](../database.py#L3240) |
...
| `rol_filtro_obra_social` | `RolFiltroObraSocial` | [2868](../database.py#L2868) |
| `rowa_cargas` | `RowaCarga` | [3417](../database.py#L3417) |
| `rowa_nuevos` | `RowaNuevo` | [3450](../database.py#L3450) |
| `rowa_snapshots` | `RowaSnapshot` | [3403](../database.py#L3403) |
| `rutas_reparto` | `RutaReparto` | [840](../database.py#L840) |
| `stock_differences` | `StockDifference` | [1993](../database.py#L1993) |
...
| `usuarios` | `Usuario` | [2507](../database.py#L2507) |
| `usuarios_pedidos` | `UsuarioPedido` | [1437](../database.py#L1437) |
| `vendedor_bookmark` | `VendedorBookmark` | [2814](../database.py#L2814) |
| `web_producto_imagen` | `WebProductoImagen` | [3387](../database.py#L3387) |
| `web_rubros_publicados` | `WebRubroPublicado` | [3365](../database.py#L3365) |
...
| `/api/lab-drog/asignar-bulk` | POST | [`api_lab_drog_asignar_bulk`](../routes/compras_dia.py#L2385) |
| `/api/lab-drog/toggle` | POST | [`api_lab_drog_toggle`](../routes/compras_dia.py#L2358) |
| `/api/matriz/drog-config` | POST | [`api_matriz_drog_config`](../routes/compras_dia.py#L2339) |
...
| `/api/pedidos/dia/buscar-producto` | GET | [`api_compras_dia_buscar_producto`](../routes/compras_dia.py#L2044) |
| `/api/pedidos/dia/contrastar` | POST | [`api_contrastar_monroe`](../routes/compras_dia.py#L688) |
...
| `/compras/labs-drogerias` | GET | [`labs_drogerias_matriz`](../routes/compras_dia.py#L2259) |
| `/compras/multi-lab` | GET | [`compras_multi_lab`](../routes/compras_dia.py#L1802) |
| `/pedidos-emitidos` | GET | [`pedidos_emitidos_list`](../routes/compras_dia.py#L2505) |
| `/pedidos-emitidos/<int:pedido_id>` | GET | [`pedido_emitido_detalle`](../routes/compras_dia.py#L2555) |
| `/pedidos/dia` | GET | [`compras_dia`](../routes/compras_dia.py#L129) |
| `/pedidos/dia/armar` | GET | [`compras_dia_armar`](../routes/compras_dia.py#L777) |
...
| Ruta | Métodos | Función |
|---|---|---|
| `/api/compras/consulta/monroe` | POST | [`consulta_compras_monroe`](../routes/consulta_compras.py#L234) |
| `/compras/consulta` | GET | [`consulta_compras`](../routes/consulta_compras.py#L217) |
| `/compras/consulta/export.xlsx` | GET | [`consulta_compras_export`](../routes/consulta_compras.py#L251) |
