...
Generado: 2026-08-24 17:05 · rama `feat/minimos-priorizados-y-editables` · commit `8ee1371`

**796 rutas** en 77 archivos · **128 modelos** · **21 syncs** · **35 services** · **11 parsers**
...
| `pedido_items` | `PedidoItem` | [2115](../database.py#L2115) |
