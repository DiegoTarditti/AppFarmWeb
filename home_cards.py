...
ACCIONES_HOME = [
    ...
    },
    {
        ...
        'desc': 'Análisis por lab o droguería (mobile)',
        'endpoint': 'consulta_stock',
        'emoji': '📦',
        'tone': 'mint',
        'badge_key': None,
        'icono_path': 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4',
        'bg_default': '#E8F3ED',
        'fg_default': '#2E7D5B',
    },
    {
    ...
    {
        'id': 'consulta_lab',
        'titulo': 'Consultar laboratorio',
        'desc': 'Top productos, médicos y OS por lab',
        'endpoint': 'consulta_lab',
        'emoji': '🧪',
        'tone': 'mint',
        'badge_key': None,
        'icono_path': 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z',
        'bg_default': '#D1FAE5',
        'fg_default': '#065F46',
    },
    {
    ...
    },
    {
        ...
        'endpoint': 'flujo_fondos',
        'emoji': '💰',
        'tone': 'mint',
        'badge_key': None,
        'icono_path': 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
        'bg_default': '#D1FAE5',
        'fg_default': '#065F46',
    },
    {
    ...
    },
    {
        'id': 'rowa',
        'titulo': 'Robot Rowa',
        'desc': 'Optimizar stock y compras del robot dispensador',
        'endpoint': 'rowa_dashboard',
        'emoji': '🤖',
        'tone': 'mint',
        'badge_key': None,
        'icono_path': 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z',
        'bg_default': '#E8F3ED',
        'fg_default': '#2E7D5B',
    },
]
